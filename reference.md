...
- **`hsm/error`**: Dispatched when activities throw exceptions
...
### Activity Errors
When activities throw exceptions, an `hsm/error` event is automatically dispatched with the exception in the event data.
